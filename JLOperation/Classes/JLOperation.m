...
static NSInteger JLOperationObservanceContext;
...
- (void)addFinishObserver {
    [self addObserver:self forKeyPath:@"isFinished" options:NSKeyValueObservingOptionNew context:&JLOperationObservanceContext];
}
- (void)removeFinishObserver {
    [self removeObserver:self forKeyPath:@"isFinished" context:&JLOperationObservanceContext];
}
...
- (void)observeValueForKeyPath:(nullable NSString *)keyPath ofObject:(nullable id)object change:(nullable NSDictionary<NSString*, id> *)change context:(nullable void *)context {
    if(context == &JLOperationObservanceContext) {
