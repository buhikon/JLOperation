...
#import "JLInvocationOperation.h"
#import "JLOperationQueue.h"

@interface JLInvocationOperation ()
...
- (void)addFinishObserver {
    [self addObserver:self forKeyPath:@"isFinished" options:NSKeyValueObservingOptionNew context:&JLInvocationOperationObservanceContext];
}
- (void)removeFinishObserver {
    [self removeObserver:self forKeyPath:@"isFinished" context:&JLInvocationOperationObservanceContext];
}
...
- (void)observeValueForKeyPath:(nullable NSString *)keyPath ofObject:(nullable id)object change:(nullable NSDictionary<NSString*, id> *)change context:(nullable void *)context {
    if(context == &JLInvocationOperationObservanceContext) {
